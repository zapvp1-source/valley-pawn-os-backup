...
## 2026-08-21 — Catch-up run + REV 2.1 hardening
Run fired Friday 8/21; no 2026-08-20 EOM files (weekly-store-kpis is a Monday pull). Fell back to freshest complete set (2026-08-16, all 5 stores) instead of skipping. OK compile: Company 15.86% (CUL 16.18 / HAR 17.92 / LEX 8.90 / ROA 16.40 / WAY 17.06). Canvas section replaced in place with as-of date; channel post + Joshua DM sent. Gap found: no yield JSONs for 8/9 or 8/16 Mondays (last compile was 8/2) — this run closed the gap. Hardened SKILL.md with REV 2.1 fallback rule: always compute from freshest complete EOM set, publish with explicit as-of date, never skip the week. Details (Live) Sheet still not updatable via connected tools (unchanged since 7/15).

...
Main() {
    ...
    REPORT_HANDLERS["jewelry-case-rings"]     := PullJewelryCaseRings
    REPORT_HANDLERS["jewelry-case-pendants"]  := PullJewelryCasePendants
    REPORT_HANDLERS["jewelry-case-earrings"]  := PullJewelryCaseEarrings

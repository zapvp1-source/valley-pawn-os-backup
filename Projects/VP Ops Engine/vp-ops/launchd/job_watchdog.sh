#!/bin/bash
# Native launchd wrapper for job_watchdog — see BUILD_SPEC.md Hard Rule #7
...
exec /usr/bin/python3 "/Users/joshuadavis/Documents/Claude/Projects/VP Ops Engine/vp-ops/jobs/job_watchdog.py" --live

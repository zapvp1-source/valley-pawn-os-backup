#!/bin/bash
# Native launchd wrapper for job_fpd_ranking — see BUILD_SPEC.md Hard Rule #7
...
exec /usr/bin/python3 "/Users/joshuadavis/Documents/Claude/Projects/VP Ops Engine/vp-ops/jobs/job_fpd_ranking.py" --shadow

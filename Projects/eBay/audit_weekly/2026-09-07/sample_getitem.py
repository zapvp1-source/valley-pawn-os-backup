#!/usr/bin/env python3
# GetMyeBaySelling under-returns detail fields again this run (pics/specifics/BestOffer/ReturnPolicy/
# DispatchTime all None on the bulk pull -- same gap hit 2026-08-31 and 2026-08-22). Sample-verify via
# GetItem, same methodology.

...
Do not touch the campaign draft or its schedule — that is entirely the 12:30 PM compiler's job. This task only reads Slack and, if needed, posts one reminder message.
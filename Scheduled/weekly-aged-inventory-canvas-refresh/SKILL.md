...
```bash
python3 "$HOME/Documents/Claude/Projects/Valley Pawn OS/bin/vp_receipt.py" write weekly-aged-inventory-canvas-refresh \
  --surface canvas --target "F0BHDL6AULU" --note "<first line of what you published>"
```

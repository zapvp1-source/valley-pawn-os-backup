...
If `/u/1/` prompts for a password or passkey, stop and post a Slack notice asking Joshua to sign in once — don't try `/u/0/` or home.nest.com as fallbacks, the cameras aren't there.

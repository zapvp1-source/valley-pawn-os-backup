...
```bash
python3 "$HOME/Documents/Claude/Projects/Valley Pawn OS/bin/vp_receipt.py" write weekly-loan-review-canvas-refresh \
  --surface canvas --target "F0BH6BJ0PK7" --note "<first line of what you published>"
```

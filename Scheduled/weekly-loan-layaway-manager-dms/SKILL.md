...
If the file doesn't exist or is more than 2 days old, post a message to #claude-updates (C0ARGG65YQM) saying the results file is missing and the Sunday review may not have completed, then stop.
...
## Step 5 — Confirm in #claude-updates
Post a brief confirmation to #claude-updates (C0ARGG65YQM) when all DMs are sent:

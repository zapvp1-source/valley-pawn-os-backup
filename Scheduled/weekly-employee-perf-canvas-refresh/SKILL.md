...
```bash
python3 "$HOME/Documents/Claude/Projects/Valley Pawn OS/bin/vp_receipt.py" write weekly-employee-perf-canvas-refresh \
  --surface canvas --target "F0BH9UK284S" --note "<first line of what you published>"
```

...
1. Write the complete, final message text (exactly as it should appear, Slack mrkdwn, no task ids,
   ...
   `/Users/joshuadavis/Documents/Claude/Projects/Valley Pawn OS/fleet/outbox/weekly-social-media-recap-<YYYYMMDD-HHMMSS>.txt`
2. Write the envelope, same base name, `.json`:
   `{"channel": "C0BMRC2LN3D", "file": "<the absolute path of the .txt you just wrote>"}`

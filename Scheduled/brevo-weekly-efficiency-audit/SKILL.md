...
- Draft calendar runway: `GET /emailCampaigns?status=draft&limit=100`, count how many future-dated weekly drafts remain staged. If fewer than 8 weeks of runway remain, that is your top-priority fix this run (see Step 4). (Floor raised 4→8 on 2026-09-05: the primary stager is now the quarterly `brevo-stage-next-quarter` task — this audit is the safety net, and 8 weeks gives two full months to notice a stall.)
